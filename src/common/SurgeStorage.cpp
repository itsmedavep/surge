...
void SurgeStorage::midi_controller_names()
{
    ...
    names[33] = "LSB for Ctrl 1";
    names[34] = "LSB for Ctrl 2";
    names[35] = "LSB for Ctrl 3";
    names[36] = "LSB for Ctrl 4";
    names[37] = "LSB for Ctrl 5";
    names[38] = "LSB for Ctrl 6";
    names[39] = "LSB for Ctrl 7";
    names[40] = "LSB for Ctrl 8";
    names[41] = "LSB for Ctrl 9";
    names[42] = "LSB for Ctrl 10";
    names[43] = "LSB for Ctrl 11";
    names[44] = "LSB for Ctrl 12";
    names[45] = "LSB for Ctrl 13";
    names[46] = "LSB for Ctrl 14";
    names[47] = "LSB for Ctrl 15";
    names[48] = "LSB for Ctrl 16";
    names[49] = "LSB for Ctrl 17";
    names[50] = "LSB for Ctrl 18";
    names[51] = "LSB for Ctrl 19";
    names[52] = "LSB for Ctrl 20";
    names[53] = "LSB for Ctrl 21";
    names[54] = "LSB for Ctrl 22";
    names[55] = "LSB for Ctrl 23";
    names[56] = "LSB for Ctrl 24";
    names[57] = "LSB for Ctrl 25";
    names[58] = "LSB for Ctrl 26";
    names[59] = "LSB for Ctrl 27";
    names[60] = "LSB for Ctrl 28";
    names[61] = "LSB for Ctrl 29";
    names[62] = "LSB for Ctrl 30";
    names[63] = "LSB for Ctrl 31";
    ...
    names[69] = "Hold 2";
    names[70] = "Sound Variation";
    names[71] = "Timbre/Harmonic Intensity";
    names[72] = "Release Time";
    names[73] = "Attack Time";
    names[74] = "Brightness";
    names[75] = "Decay Time";
    names[76] = "Vibrato Rate";
    names[77] = "Vibrato Depth";
    names[78] = "Vibrato Delay";
    names[79] = "Ctrl 79";
    names[80] = "General 5";
    names[81] = "General 6";
    names[82] = "General 7";
    ...
    std::set<std::string> unmappableControls;
    
    unmappableControls.insert("Bank Select");
    unmappableControls.insert("LSB for Control 0 (Bank Select)");
    unmappableControls.insert("Damper Pedal on/off (Sustain)");
    unmappableControls.insert("[Channel Mode Message] All Sound Off");
    unmappableControls.insert("[Channel Mode Message] All Notes Off");
}
